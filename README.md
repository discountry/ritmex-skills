...
| **[agent-handoff](skills/agent-handoff/SKILL.md)** | Continue the latest unfinished coding task between Claude Code and Codex using native session history and a deterministic snapshot of the current Git workspace. Preserves the current directory, branch, and existing changes. |
...
# anti-ui-slop — AI-generated UI anti-pattern detector & fixer
npx skills add discountry/ritmex-skills --skill anti-ui-slop
...
# agent-handoff — Continue unfinished work across Claude Code and Codex
npx skills add discountry/ritmex-skills --skill agent-handoff
```
